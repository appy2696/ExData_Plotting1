...
plot(rdata$Time, rdata$Global_active_power, type="l", xlab="", ylab="Global Active Power")

# Second plot

plot(rdata$Time, rdata$Voltage, type="l", xlab="datetime", ylab="Voltage")
...
plot(rdata$Time, rdata$Global_reactive_power, type="l", xlab="datetime", ylab="Global_reactive_power")
